...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../../../node_modules/@sentry/nuxt/build/module/runtime/plugins/route-detector-legacy.server.js")> &
...
declare module '#app' {
  ...
  interface NuxtAppLiterals {
    pluginName: 'vue-devtools-client' | 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:router' | 'nuxt:browser-devtools-timing' | 'nuxt:payload' | 'nuxt:revive-payload:server' | 'nuxt:chunk-reload' | 'nuxt:global-components' | 'nuxt:prefetch' | 'nuxt:checkIfPageUnused' | 'sentry-client-config' | '@nuxt/icon' | 'nuxt:checkIfLayoutUsed' | 'sentry-client-integrations'
  }
}
