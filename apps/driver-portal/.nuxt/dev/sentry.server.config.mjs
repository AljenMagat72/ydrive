import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import * as path from 'node:path';
import { resolve, dirname, join } from 'node:path';
import { DEV_ENVIRONMENT, DEFAULT_ENVIRONMENT, applySdkMetadata, getGlobalScope, vercelWaitUntil, debug, flush, getIsolationScope, getDefaultIsolationScope, withIsolationScope, flushIfServerless, getActiveSpan, getRootSpan, SEMANTIC_ATTRIBUTE_SENTRY_SOURCE, getTraceMetaTags, getClient, getCurrentScope, captureException, startSpan, SPAN_STATUS_OK, SEMANTIC_ATTRIBUTE_CACHE_HIT, SPAN_STATUS_ERROR, SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN, SEMANTIC_ATTRIBUTE_CACHE_KEY, SEMANTIC_ATTRIBUTE_SENTRY_OP } from 'file:///home/hoana/YDrive/y-drive/node_modules/@sentry/core/build/esm/index.js';
import { init as init$1, getDefaultIntegrations, httpIntegration } from 'file:///home/hoana/YDrive/y-drive/node_modules/@sentry/node/build/esm/index.js';
import { isCjs } from 'file:///home/hoana/YDrive/y-drive/node_modules/@sentry/node-core/build/esm/index.js';
import { tmpdir } from 'node:os';
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, H3Error, removeResponseHeader, getResponseStatus, getQuery as getQuery$1, readBody, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, getCookie, getHeaders, getResponseStatusText } from 'file:///home/hoana/YDrive/y-drive/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import crypto$1 from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///home/hoana/YDrive/y-drive/node_modules/@vue/shared/dist/shared.cjs.js';
import viteNodeEntry_mjs from 'file:///home/hoana/YDrive/y-drive/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
import { viteNodeFetch } from 'file:///home/hoana/YDrive/y-drive/node_modules/@nuxt/vite-builder/dist/vite-node.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///home/hoana/YDrive/y-drive/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL, encodePath } from 'file:///home/hoana/YDrive/y-drive/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///home/hoana/YDrive/y-drive/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///home/hoana/YDrive/y-drive/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///home/hoana/YDrive/y-drive/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///home/hoana/YDrive/y-drive/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///home/hoana/YDrive/y-drive/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, defineDriver, prefixStorage } from 'file:///home/hoana/YDrive/y-drive/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/hoana/YDrive/y-drive/node_modules/unstorage/drivers/fs.mjs';
import fsDriver from 'file:///home/hoana/YDrive/y-drive/node_modules/unstorage/drivers/fs-lite.mjs';
import lruCache from 'file:///home/hoana/YDrive/y-drive/node_modules/unstorage/drivers/lru-cache.mjs';
import { digest, hash as hash$1 } from 'file:///home/hoana/YDrive/y-drive/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///home/hoana/YDrive/y-drive/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/hoana/YDrive/y-drive/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/hoana/YDrive/y-drive/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///home/hoana/YDrive/y-drive/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/hoana/YDrive/y-drive/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///home/hoana/YDrive/y-drive/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///home/hoana/YDrive/y-drive/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///home/hoana/YDrive/y-drive/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///home/hoana/YDrive/y-drive/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///home/hoana/YDrive/y-drive/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/hoana/YDrive/y-drive/node_modules/errx/dist/index.js';
import { isVNode, isRef, toValue } from 'file:///home/hoana/YDrive/y-drive/node_modules/vue/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file:///home/hoana/YDrive/y-drive/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///home/hoana/YDrive/y-drive/node_modules/pathe/dist/index.mjs';
import { basename } from 'file:///home/hoana/YDrive/y-drive/node_modules/@nuxt/icon/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///home/hoana/YDrive/y-drive/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///home/hoana/YDrive/y-drive/apps/driver-portal/.nuxt/nuxt-icon-server-bundle.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/hoana/YDrive/y-drive/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///home/hoana/YDrive/y-drive/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///home/hoana/YDrive/y-drive/node_modules/unhead/dist/utils.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///home/hoana/YDrive/y-drive/node_modules/ipx/dist/index.mjs';
import { isAbsolute } from 'file:///home/hoana/YDrive/y-drive/node_modules/@nuxt/image/node_modules/pathe/dist/index.mjs';
...
function init(options) {
  const envFallback = !isCjs() && true ? DEV_ENVIRONMENT : DEFAULT_ENVIRONMENT;
  const sentryOptions = {
...
const serverAssets = [{"baseName":"server","dir":"/home/hoana/YDrive/y-drive/apps/driver-portal/server/assets"}];
...
const _47home_47hoana_47YDrive_47y_45drive_47apps_47driver_45portal_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js = defineDriver(
  /**
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/hoana/YDrive/y-drive/apps/driver-portal","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/hoana/YDrive/y-drive/apps/driver-portal/server","watchOptions":{"ignored":[null]}}));
storage.mount('cache:nuxt:payload', _47home_47hoana_47YDrive_47y_45drive_47apps_47driver_45portal_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"/home/hoana/YDrive/y-drive/apps/driver-portal/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"/home/hoana/YDrive/y-drive/apps/driver-portal/.nuxt/cache/nuxt/payload"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/hoana/YDrive/y-drive/apps/driver-portal/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/hoana/YDrive/y-drive/apps/driver-portal/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/hoana/YDrive/y-drive/apps/driver-portal/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/home/hoana/YDrive/y-drive/apps/driver-portal/public"
      ]
    },
    "http": {
      "domains": []
...
const _VwWJGV16P7nJ7k4Rq1YK3TbZP6oBjPF0h_y3EYMRM = (function(nitro) {
...
const _X9S4CVE1_RXoSNzAwUslMw_toZ6b_B4IQ6bfPiXpyI = (nitroApp) => {
...
const _VdkUh1poxYCPQkbbGC7lJHNhV32Lrn9pAp1uqjcKg1k = (nitroApp) => {
...
const _8KOKUqyLzYrn5f8ZovRNfTVxQlZNJNIu0CDDPVYQ = (nitroApp) => {
...
const _eJxgO_qC8nmvJPczW7wQrmYQtD340LopwB5d0O5b1c = async (_nitroApp) => {
  await createStoragePlugin(useStorage, userStorageMounts);
};

const rootDir = "/home/hoana/YDrive/y-drive/apps/driver-portal";

const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[],"noscript":[],"title":"Driver Portal"};
...
const _QvWQq5GJyBY8PL6Vgfx4cisSiQut4khl4mz_Vikssc = (nitroApp) => {
...
const _M9a5slZ1BwEkC8d4v_bFbvwJBavEPpGvXxPzdVHsDgg = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const plugins = [
  _VwWJGV16P7nJ7k4Rq1YK3TbZP6oBjPF0h_y3EYMRM,
_X9S4CVE1_RXoSNzAwUslMw_toZ6b_B4IQ6bfPiXpyI,
_VdkUh1poxYCPQkbbGC7lJHNhV32Lrn9pAp1uqjcKg1k,
_8KOKUqyLzYrn5f8ZovRNfTVxQlZNJNIu0CDDPVYQ,
_eJxgO_qC8nmvJPczW7wQrmYQtD340LopwB5d0O5b1c,
_QvWQq5GJyBY8PL6Vgfx4cisSiQut4khl4mz_Vikssc,
_M9a5slZ1BwEkC8d4v_bFbvwJBavEPpGvXxPzdVHsDgg,
...
const _MVCIYP = eventHandler((event) => {
...
const _aFfYxK = defineCachedEventHandler(async (event) => {
...
const _NtTnpv = lazyEventHandler(() => {
...
const _lazy_m1SZCX = () => Promise.resolve().then(function () { return _____$1; });
const _lazy_2HaFqt = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _MVCIYP, lazy: false, middleware: true, method: undefined },
  { route: '/api/**', handler: _lazy_m1SZCX, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_2HaFqt, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _aFfYxK, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _NtTnpv, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_2HaFqt, lazy: true, middleware: false, method: undefined }
];
