  ...
  <div class="dark:bg-black border rounded-2xl p-6 flex flex-col gap-4 w-full max-w-sm shadow-blue h-full relative">
    ...
    <div class="flex items-center justify-center w-full gap-2 relative">
      <div class="flex items-center gap-2">
        ...
        <span class="text-lg sm:text-xl font-semibold tracking-tight dark:text-white truncate">Ownership</span>
      </div>
      <div class="shrink-0">
      ...
      <div class="flex flex-col justify-top space-y-2 w-full">
        <div class="space-y-1">
          <p class="text-sm flex justify-between gap-2">
            <span class="font-semibold dark:text-black">Registration Expiry:</span> 
