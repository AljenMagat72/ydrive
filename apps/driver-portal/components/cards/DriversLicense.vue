...
const { fullName, phone, dob, licenseClass, licenseExp, fetchSecureImage } = useZoho();
      ...
      <div class="flex flex-col justify-top space-y-2 w-full flex-grow">
        <div class="space-y-1">
          ...
          <p class="text-white text-sm flex justify-between items-center gap-2">
            <span class="font-semibold text-white">Class:</span> 
            <span>{{ licenseClass || 'N/A' }}</span>
          </p>
          <p class="text-white text-sm flex justify-between items-center gap-2">
