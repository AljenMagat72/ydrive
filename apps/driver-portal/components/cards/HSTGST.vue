...
import { Receipt, Mail } from 'lucide-vue-next';
      ...
      <div class="flex flex-col justify-top space-y-2 w-full flex-grow">
        <div class="space-y-1">
          <p class="text-white text-sm flex justify-between gap-2">
            <span class="font-semibold text-gray-400">Tax ID:</span> 
            <span class="truncate text-right text-white">{{ hstGst || '---' }}</span>
          </p>
        </div>
      </div>
