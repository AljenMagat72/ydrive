...
import { type CalendarDate, type CalendarDateTime, today } from '@internationalized/date';
...
<template>
  <Card class="flex-grow py-0 overflow-hidden">
    <div
      ref="container"
      class="overflow-scroll cursor-all-scroll flex flex-col h-full"
    >
      <div class="flex-grow text-sm whitespace-nowrap flex flex-col min-w-fit min-h-fit">
        <div
        ...
        <div class="relative flex-grow h-full">
          ...
          >
            <div
              v-for="([key, value], driverIndex) in Array.from(schedules)"
              :key="key"
