  ...
  >
    ...
    >
      ...
      <div
        ...
        :class="{
          'flex items-center cursor-pointer px-5 md:px-6 py-2 gap-x-3 font-bold text-base md:text-lg text-white background-blue  dark:bg-[#1C1C1D]':
            openMenu === 'drivers',
          'flex items-center cursor-pointer px-5 md:px-6 py-2 gap-x-3 font-bold text-base md:text-lg leading-5 color-blue rounded hover:bg-ydrive-blue hover:text-white dark:text-white/70':
            openMenu !== 'drivers',
        }"
      >
