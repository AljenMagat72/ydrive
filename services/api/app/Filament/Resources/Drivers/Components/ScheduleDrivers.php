...
namespace App\Filament\Resources\Drivers\Components;
...
class ScheduleDrivers extends Component implements HasForms
{
    ...
    {
        return view('admin::components.schedule-drivers')
            ->layout('admin::layouts.widget');
    }
}
