...
{
    use HasApiTokens, HasFactory, Notifiable, SoftDeletes, HasActivity, HasOneTimePasswords;
    ...
    public function scopeHasScheduledHours(
        Builder $query,
        Carbon $rangeStart,
        Carbon $rangeEnd
    ) {
    ...
    protected function resolvedMinimumAcceptanceRate(): Attribute
    {
        return Attribute::make(
            get: fn() => $this->minimum_acceptance_rate ?? app(DriverSettings::class)->minimum_acceptance_rate,
        );
    }

    protected function resolvedMinimumScheduledHours(): Attribute
    {
        return Attribute::make(
            get: fn() => $this->minimum_scheduled_hours ?? app(DriverSettings::class)->minimum_scheduled_hours,
        );
    }
