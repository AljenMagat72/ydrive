...
class RevertDelinquent extends Command
{
  /**
   ...
   * @var string
   */
  protected $signature = 'driver:revert-delinquent {autofleet_id} {notify?}';
   ...
   * @var string
   */
  protected $description = 'Revert a drivers delinquent status, optionally with a notification';
