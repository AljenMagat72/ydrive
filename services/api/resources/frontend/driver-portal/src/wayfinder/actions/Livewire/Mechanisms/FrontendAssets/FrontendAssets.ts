...
* @route '/livewire-a5e98bd8/livewire.js'
*/
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-a5e98bd8/livewire.js',
...
* @route '/livewire-a5e98bd8/livewire.min.js.map'
*/
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-a5e98bd8/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/livewire-a5e98bd8/livewire.csp.min.js.map'
*/
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-a5e98bd8/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
