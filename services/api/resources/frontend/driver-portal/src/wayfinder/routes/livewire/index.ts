...
* @route '/livewire-a5e98bd8/upload-file'
*/
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-a5e98bd8/upload-file',
...
* @route '/livewire-a5e98bd8/preview-file/{filename}'
*/
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-a5e98bd8/preview-file/{filename}',
