@php use App\Filament\Resources\Drivers\DriverResource; @endphp
        ...
        <div class="flex-1 relative">
            ...
            >
                <div class="w-full min-w-max h-full min-h-max flex flex-col">
                    <div class="grid grid-cols-24 auto-rows-auto sticky top-0 py-2 z-10 bg-zinc-50 dark:bg-zinc-950 border-b border-zinc-200 dark:border-white/10 text-zinc-500 dark:text-zinc-400 font-medium">
                    ...
                    <div class="relative bg-striped fi-color-gray grow">
                        <template x-if="new Date().toLocaleString('en-CA').slice(0, 10) === '{{ \Carbon\Carbon::parse($this->date)->toDateString() }}'">
                            <div
                            ...
                            <div class="relative h-8 my-2">
                                @foreach($schedule as $shift)
                                    <a
                                        ...
                                        href="{{ DriverResource::getUrl('view', ['record' => $shift['driver']['uuid']]) }}"
                                    >
